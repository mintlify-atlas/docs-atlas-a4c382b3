---
title: "Process"
description: "Running container created from a release"
---

A Process is a running container that is created by running a command on a [Release](/reference/primitives/release).

Long-running Processes are created by [Services](/reference/primitives/service) and will be automatically recreated upon termination.
